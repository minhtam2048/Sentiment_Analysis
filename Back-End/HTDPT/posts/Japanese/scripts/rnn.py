...
def RNNKeras(embeddingMatrix = None, embed_size = 300, max_features = 20000, maxlen = 100, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
...
def RNNKerasCPU(embeddingMatrix = None, embed_size = 300, max_features = 20000, maxlen = 100, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
        inp = Input(shape=(maxlen, embed_size))
        x = inp
    else:
...
def LSTMKeras(embeddingMatrix = None, embed_size = 300, max_features = 20000, maxlen = 100):
    inp = Input(shape = (maxlen, ))
...
def SARNNKerasCPU(embeddingMatrix = None, embed_size = 300, max_features = 20000, maxlen = 100, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
        inp = Input(shape=(maxlen, embed_size))
        x = inp
    else:
    ...
    return model
# ***
def SARNNKeras(embeddingMatrix = None, embed_size = 300, max_features = 20000, maxlen = 100, rnn_type = CuDNNLSTM, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
        inp = Input(shape=(maxlen, embed_size))
        x = inp
    else:
...
def HRNNCPU(embeddingMatrix = None, embed_size = 300, max_features = 20000, max_nb_sent = 3, max_sent_len = 40, trainable = True, use_additive_emb = False):
...
def HRNN(embeddingMatrix = None, embed_size = 300, max_features = 20000, max_nb_sent = 3, max_sent_len = 40, trainable = True, use_additive_emb = False):
    sent_inp = Input(shape = (max_sent_len, embed_size))
    embed = Embedding(
        input_dim = max_features,
        output_dim = embed_size,
...
def OriginalHARNNCPU(embeddingMatrix = None, embed_size = 300, max_features = 20000, max_nb_sent = 3, max_sent_len = 40, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
        sent_inp = Input(shape = (max_sent_len, embed_size))
        embed = sent_inp
    else:
...
def OriginalHARNN(embeddingMatrix = None, embed_size = 300, max_features = 20000, max_nb_sent = 3, max_sent_len = 40, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
        sent_inp = Input(shape = (max_sent_len, embed_size))
        embed = sent_inp
    else:
...
def HARNNCPU(embeddingMatrix = None, embed_size = 300, max_features = 20000, max_nb_sent = 3, max_sent_len = 40, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
        sent_inp = Input(shape = (max_sent_len, embed_size))
        embed = sent_inp
    else:
...
# ***
def HARNN(embeddingMatrix = None, embed_size = 300, max_features = 20000, max_nb_sent = 3, max_sent_len = 40, use_fasttext = False, trainable = True, use_additive_emb = False):
    if use_fasttext:
        sent_inp = Input(shape = (max_sent_len, embed_size))
        embed = sent_inp
    else:
